...
# SETT DENNE TIL 0 N?R DU SKAL LEVERE
test_mode: .word   0 
...
str2:      .string " p? addresselokasjon "

str3:      .string "St?rste tall: "


.text

# Programmet starter her
# Sett test_mode til 0 n?r du skal levere!
lw a7, test_mode
...
find_max:
    # TODO Gj?r klar teller (a2 = 0) (en instruksjon)
    li a2, 0
...
fm_loop_start:
    ...
    # TODO Regn ut adressen vi skal lese fra ved ? bruke indeksen i a2 (flere instruksjoner)
    li a4, 4
    mul a5, a4, a2
    add a5, a0, a5
    ...
    # TODO Sett a3 til denne verdien hvis den er st?rre en lokalt maksimum i a3. Hvis ikke, hopp over og fortsett. Bruk logikk liknende den i ?ving 2 (flere instruksjoner) 
    blt a6, a3, hopp
    addi a3, a6, 0
